...
namespace CompanyWebSite.Controllers
{
    public partial class AdminController
    {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string AllRequests = "AllRequests";
        ...
        public class ViewsClass
        {
            ...
            public readonly string AllRequests = "~/Views/Admin/AllRequests.cshtml";
            public readonly string Index = "~/Views/Admin/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AdminController : CompanyWebSite.Controllers.AdminController
    {
        ...
        [NonAction]
        partial void AllRequestsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult AllRequests()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.AllRequests);
            AllRequestsOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void DownloadFileOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int requestId);

        [NonAction]
        public override System.Web.Mvc.ActionResult DownloadFile(int requestId)
        {
            ...
            DownloadFileOverride(callInfo, requestId);
            return callInfo;
        }
